...
async function main() {
    ...
    program
        ...
        try {
            ...
            await SandboxManager.initialize(runtimeConfig, undefined, !!process.env.SRT_DEBUG);
            ...
            if (options.c) {
                ...
                // splits arguments containing whitespace (#157) and mangles
                // parentheses, quotes, backticks, and $.
