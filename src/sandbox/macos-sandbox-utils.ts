...
function generateSandboxProfile({
  ...
  const profile: string[] = [
    ...
    '; security.mac.sandbox.sentinel is a convention, not an enforcement boundary.',
    '; Keychain clients read it before attempting credential writes and abort with',
    '; EPERM when the sandbox blocks the read. Seatbelt rules remain authoritative.',
    ...
    '; securityd handles legacy Keychain IPC; secd handles CRUD on macOS 13+.',
